...
# Your function can assume the list returned from the Open Notify API will have the following
# structure:
...
# Your function should *not* assume that the user will input the astronaut's name as a scalar
# character vector, and should throw an error if they do not. The accuracy of your function should
# also not depend on there being exactly 12 astronauts in space.
